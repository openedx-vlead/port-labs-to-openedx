...
*** Lab structure of Virtual-Labs
  + A Virtual-Lab is structured with following sections :
    + Introduction
    + List of Experiments
    + Target Audience
    + Courses
    + Pre-requisites
    + Feedback
  + Within list of experiments, several experiments are listed with
    possible following sections (sections could vary from one
    experiment to other) :
    + Introduction
    + Theory
    + Objective
...
*** Lab structure of Open edX lab
    ...
    + The content of the lab (HTML/text/images/simulations) would be
      ...
      recommended. Following the above link is highly recommended as
      it would enhance the understanding of Open edX terminologies and
      their usage.
