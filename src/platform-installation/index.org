...
** Disable course creation for users on edX-Studio
   ...
   3) Restart the edX services
      #+BEGIN_EXAMPLE 
      sudo /edx/etc/supervisord.conf restart all:
      #+END_EXAMPLE
...
* [[./administration.org][Administration of Open edX platform]]

* [[./trouble-shooting.org][Trouble Shooting of Open edX platform]]
