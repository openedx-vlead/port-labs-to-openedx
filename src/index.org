...
** Take backup of existing database from Kifli release and restore it into cypress release
   ...
   - This could not migrate database into new release of Open edX
     ...
     to new schema.
** Take backup of cypress and restore it into newly created edX platform which has cypress release
   - Take backup 
   - Save 
   - Launch new VM with required configuration details (Ubuntu 12.04)
