...
* Labs chosen
  ...
  |------+--------------------------+------------------------+------+----------+-----------|
  |   4. | Mine Automation          | Mechanical Engineering | [[http://iitkgp.vlab.co.in/?sub=40&brch=137][Link]] | [[https://github.com/vlead/open-edx-mine-automation][Link]]     |           |
  |      | and Virtual Reality      |                        |      |          |           |
  |------+--------------------------+------------------------+------+----------+-----------|
  |   5. | Chemical Engineering     | Chemical Engineering   | [[http://ce-iitb.vlabs.ac.in/][Link]] | [[https://github.com/vlead/open-edx-chemical-engineering][Link]]     |           |
  |------+--------------------------+------------------------+------+----------+-----------|
  |   6. | Virtual Chemistry Lab    | Chemical Sciences      | [[http://vc-dei.vlabs.ac.in/][Link]] |          |           |
  |------+--------------------------+------------------------+------+----------+-----------|
  |   7. | Industrial Electric      | Electrical             | [[http://ied-nitk.vlabs.ac.in/][Link]] | [[https://github.com/vlead/open-edx-industrial-electric-drives-lab][Link]]     |           |
  ...
  |      | Laboratory               |                        |      |          |           |
  |------+--------------------------+------------------------+------+----------+-----------|
  |   9. | Hybrid Electronics       | Electronics &          | [[http://he-coep.vlabs.ac.in/][Link]] | [[https://github.com/vlead/open-edx-hybrid-electronics-lab][Link]]     |           |
  |      |                          | Communications         |      |          |           |
  |------+--------------------------+------------------------+------+----------+-----------|
...
* Setup of Open edX platform and analytics and its management
  - [[./analytics.org][Setup Open edX platform and Configure Open edX Analytic
  for the courses]]
