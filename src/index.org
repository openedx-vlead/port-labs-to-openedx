...
* Labs chosen
  ...
  |------+--------------------------+------------------------+------+-----------|
  | S.No | Lab Name                 | Discipline             | Lab  | Institute |
  |      |                          |                        | Url  |           |
  |------+--------------------------+------------------------+------+-----------|
  |   1. | Computer Programming     | Computer Science       | [[http://cse02-iiith.vlabs.ac.in/][Link]] |           |
  |      | Lab                      |                        |      |           |
  |------+--------------------------+------------------------+------+-----------|
  |   2. | Structural Analysis      | Civil engineering      | [[%20http://eerc04-iiith.virtual-labs.ac.in/index.php][Link]] |           |
  |------+--------------------------+------------------------+------+-----------|
