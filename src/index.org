...
* Labs chosen
  ...
  |------+--------------------------+------+------------------------+-------------+-----------|
  | S.No | Lab Name                 | Lab  | Discipline             | edX Sources | Institute |
  |      |                          | Url  |                        |             |           |
  |------+--------------------------+------+------------------------+-------------+-----------|
  |   1. | Computer Programming     | [[http://cse02-iiith.vlabs.ac.in/][Link]] | Computer Science       | [[https://github.com/vlead/Open-edX-Computer-Programming][Link]]        |           |
  |      | Lab                      |      |                        |             |           |
  |------+--------------------------+------+------------------------+-------------+-----------|
  |   2. | Structural Analysis      | [[%20http://eerc04-iiith.virtual-labs.ac.in/index.php][Link]] | Civil engineering      | [[https://github.com/vlead/Open-edX-Structural-Analysis][Link]]        |           |
  |------+--------------------------+------+------------------------+-------------+-----------|
