...
* Labs chosen
  ...
  |      | and Virtual Reality      |                        |      |          |             |
  |------+--------------------------+------------------------+------+----------+-------------|
  |   5. | Chemical Engineering     | Chemical Engineering   | [[http://ce-iitb.vlabs.ac.in/][Link]] | [[http://openedx.vlabs.ac.in/courses/IITB/chem01/Anytime/info][Link]]     | IIT, Bombay |
  |------+--------------------------+------------------------+------+----------+-------------|
  ...
  |      | of PLC                   |                        |      |          |             |
  |------+--------------------------+------------------------+------+----------+-------------|
  |   8. | Industrial Automation    | Electrical Engineering | [[http://ial-coep.vlabs.ac.in/Introduction.html][Link]] | [[https://github.com/vlead/open-edx-industrial-automation-lab][Link]]     |             |
  |      | Laboratory               |                        |      |          | COE, Pune   |
  |------+--------------------------+------------------------+------+----------+-------------|
